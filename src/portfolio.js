...
const greeting = {
  ...
  subTitle: emoji("A Software Engineer 🚀 having experience of building Web applications with JavaScript, Python, Django, Flask and some other cool libraries and frameworks."),
